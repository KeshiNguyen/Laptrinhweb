    ...
    <body >
        <form method="POST" action="" >
                        ...
                        <div class="container">
                            <div class="navbar-header ">
                                <div class="navbar-brand">
                                    <a href="http://localhost:8012/laravel/webdoctruyen/home" id="logo">
                                        <img src="//st.nettruyentv.com/data/logos/logo-nettruyen.png" class="logo" width="200px">
                                    </a>
                                </div>
                                <div class="searchbox">
                                    <form  class="form-inline">
                                        <input class="input-group" id="" type="search"  placeholder="Tim kiem..." autocomplete="off">
                                    </form>
                                </div>
                            </div>
            ...
            <main>
                ...
                <a class="navbar-brand" href="{route('home'}">WEBTRUYEN</a>
