...
<head>
    <h3 style="color: red;">DateTimeProcessing</h3>
</head>
...
?>
    <form method="post">
        Enter your name and choose a date and time:<br> <br>
...
if (array_key_exists("name", $_POST)) {
    ...
    print "Hi $name!<br>";
    print "You have chosen to have an appointment at $hours:$minutes:$seconds ,$day/$month/$year <br><br>";
    if ($hours <= 12) {
